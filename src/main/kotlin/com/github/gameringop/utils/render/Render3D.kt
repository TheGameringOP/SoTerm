...
import com.github.gameringop.utils.NumbersUtils.minus
import com.github.gameringop.utils.NumbersUtils.plus
...
object Render3D {
    ...
    fun renderLine(ctx: RenderContext, start: Vec3, finish: Vec3, color: Color, thickness: Number = 2, phase: Boolean = false) {
        ...
        val lines = if (phase) OPRenderLayers.getLinesThroughWalls(thickness.toDouble()) else OPRenderLayers.getLines(thickness.toDouble())
    ...
    fun renderTracer(ctx: RenderContext, point: Vec3, color: Color, thickness: Number = 2.5) {
        ...
        val buffer = (ctx.consumers as MultiBufferSource.BufferSource).getBuffer(OPRenderLayers.getLinesThroughWalls(thickness.toDouble()))
