...
object RenderTest {
    ...
    fun init() {
        EventBus.register<RenderWorldEvent> {
            if ("render" !in SoTerm.debugFlags) return@register
            val player = SoTerm.mc.player ?: return@register
        ...
        EventBus.register<OPDebugFlagEvent.Remove> { if (event.flag == "render") pos = null }
    }
}