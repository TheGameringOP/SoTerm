...
import com.github.gameringop.SoTerm.MOD_VERSION
...
object WebUtils {
    ...
    private val USER_AGENT = "SoTerm/$MOD_VERSION${if (SoTerm.isDev) "-dev" else ""}"
    private val SUCCESS_RANGE = 200 .. 299
    private const val TIMEOUT = 10_000

    private val threadCounter = AtomicInteger(1)
    val networkDispatcher = Executors.newFixedThreadPool(5) {
        Thread(it, "${SoTerm.MOD_NAME}-Net-${threadCounter.getAndIncrement()}").apply {
            isDaemon = true
        }
