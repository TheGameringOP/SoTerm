...
import com.github.gameringop.config.Savable
import com.github.gameringop.event.Event
import com.github.gameringop.event.EventBus.EventContext
...
open class Feature(
    ...
    protected inline val mc get() = SoTerm.mc
    protected inline val scope get() = SoTerm.scope
    protected inline val cacheData get() = SoTerm.cacheData
