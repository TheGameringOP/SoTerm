...
//            val dungeonStats = ProfileUtils.getProfile(cleanName).getOrNull()
...
//            }
//
//            val petsList = dungeonStats.pets
//            if (petsList.isEmpty()) {
//                if (SoTerm.debugFlags.contains("spirit")) {
//                    ChatUtils.modMessage("§eNo pets list in profile for $username, assuming Spirit")
//                }
...
//            var hasSpirit = false
//            for (pet in petsList) {
//                if (pet.type.equals("SPIRIT", ignoreCase = true) && pet.tier.equals("LEGENDARY", ignoreCase = true)) {
//                    hasSpirit = true
//                    break
//                }
//            }
