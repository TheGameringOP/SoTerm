...
object NetworkLoop {
    ...
    fun init() = ThreadUtils.loop(TimeUnit.MINUTES.toMillis(3)) {
        coroutineScope {
            val jobs = listOf(
    ...
    suspend fun refreshMayor() = updateElectionData()
    suspend fun refreshLowestBins() = updateLowestBins()
    suspend fun refreshBazaar() = updateBazaarPrices()
